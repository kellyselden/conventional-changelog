...
function semverTagsPromise (options) {
  return Q.Promise(function (resolve, reject) {
    gitSemverTags({ lernaTags: !!options.lernaPackage, package: options.lernaPackage, tagPrefix: options.tagPrefix, cwd: options.path }, function (err, result) {
      if (err) {
        reject(err)
      } else {
        resolve(result)
...
function mergeConfig (options, context, gitRawCommitsOpts, parserOpts, writerOpts, gitRawExecOpts) {
  ...
  gitRemoteOriginUrlPromise = Q(gitRemoteOriginUrl(options.path))
